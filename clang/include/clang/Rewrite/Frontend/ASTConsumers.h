...
CreateObjCRewriter(const std::string &InFile, std::unique_ptr<llvm::raw_ostream> OS,
...
std::unique_ptr<ASTConsumer> CreateHTMLPrinter(std::unique_ptr<llvm::raw_ostream> OS,
                                               Preprocessor &PP,
