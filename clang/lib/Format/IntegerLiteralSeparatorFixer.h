...
private:
  bool checkSeparator(const llvm::StringRef IntegerLiteral, int DigitsPerGroup) const;
  std::string format(const llvm::StringRef IntegerLiteral, int DigitsPerGroup,
