...
#define DECL(TYPE, BASE) \
    case Kind::TYPE: \
      return llvm::cast<TYPE##Decl>(this)->hasBodyImpl();
#include "clang/AST/DeclNodes.inc"
#undef DECL
#undef DECL_CONTEXT
#undef DECL_RANGE
...
Decl* Decl::getNextRedeclarationInternal() {
  switch (getKind()) {
#define ABSTRACT_DECL(Type)
#define DECL_RANGE(Base, First, Last)
#define DECL_CONTEXT(Decl)
#define DECL(TYPE, BASE) \
    case Kind::TYPE: \
      return llvm::cast<TYPE##Decl>(this)->getNextRedeclarationImpl();
#include "clang/AST/DeclNodes.inc"
#undef DECL
#undef DECL_CONTEXT
#undef DECL_RANGE
...
#define DECL(TYPE, BASE) \
    case Kind::TYPE: \
      return llvm::cast<TYPE##Decl>(this)->getPreviousDeclImpl();
#include "clang/AST/DeclNodes.inc"
#undef DECL
#undef DECL_CONTEXT
#undef DECL_RANGE
