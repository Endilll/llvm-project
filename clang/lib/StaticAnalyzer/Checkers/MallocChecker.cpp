...
namespace { struct BadFree; }
namespace { struct DoubleFree; }
namespace { struct FreeAlloca; }
namespace { struct MismatchedDealloc; }
namespace { struct OffsetFree; }
namespace { struct UseFree; }
namespace { struct UseZeroAllocated; }
